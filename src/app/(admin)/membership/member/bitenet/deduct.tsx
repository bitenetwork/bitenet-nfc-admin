...
import { DeductMemberRechargeInputs } from "~/trpc/admin/membership/type";
...
export default function DeductRecharge({ memberId, open, onClose }: Prop) {
  ...
  const { mutateAsync: deductRecharge, isLoading } =
    api.member.deductRecharge.useMutation();

  const onFinish = (inputs: DeductMemberRechargeInputs) => {
