...
export default function AddRestaurant({ open, onClose }: Prop) {
  ...
  const onFinish = (inputs: CreateRestaurantInputs) => {
    ...
    <>
      ...
      >
        ...
        >
          ...
          <Row gutter={16}>
            <Col span={12}>
              <Form.Item name="minimumCharge" label="Customer's Minimum Spending">
                <InputNumber
                  style={{ width: "100%" }}
                  min={0}
                  precision={2}
